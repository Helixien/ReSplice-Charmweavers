...
namespace ReSpliceCharmweavers
{
    ...
    public static class Xenogerm_PawnIdeoDisallowsImplanting_Patch
    {
        ...
        {
            if (!IdeoUtility.DoerWillingToDo(RS_DefOf.RS_PropagateLovehexerGene, selPawn) && __instance.GeneSet.GenesListForReading.Any((GeneDef x) => x == RS_DefOf.RS_PsychicEnthralling))
            {
                __result = true;
            }
        }
